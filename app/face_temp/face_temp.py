...
def face_recognition():  # generate frame by frame from camera
    ...
    def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
        ...
        for (x, y, w, h) in features:
            ...
            text_size = cv2.getTextSize(f"Variable C", cv2.FONT_HERSHEY_SIMPLEX, 0.8, 2)[0]  # Get text size
            ...
            cv2.putText(img, f"Variable C", (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 0), 2)
...
def delete_student(prs_nbr):
    if request.method == 'POST':
        ...
        if num_images > 0:
            ...
            dataset_dir = r"C:\\Users\\James Reniel\\mainProgram\\WebApp\\FaceSenseTempTrack\\thesis-project\\dataset"
